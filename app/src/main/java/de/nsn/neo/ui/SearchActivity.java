...
public final class SearchActivity extends Activity {
    ...
    private void open(MediaItem item){android.content.Intent intent=new android.content.Intent(this,DetailActivity.class);intent.putExtra("source",item.source.name());intent.putExtra("content",item.detailUrl==null?item.id:item.detailUrl);startActivity(intent);}
