...
public final class PlayerActivity extends Activity {
    ...
    private void showControls(boolean focusPlay){if(controls==null)return;controls.setVisibility(View.VISIBLE);controls.bringToFront();if(focusPlay&&!controlButtons.hasFocus())controlButtons.getChildAt(2).requestFocus();uiHandler.removeCallbacks(hideControls);uiHandler.postDelayed(hideControls,2800);}
